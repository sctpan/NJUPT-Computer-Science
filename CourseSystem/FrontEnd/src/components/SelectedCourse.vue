<template>
  <div>
    ...
    <Button type="primary" @click="dropCourse">退选课程</Button>
  </div>
</template>
<script>
  export default {
    ...
    methods: {
      getCourses(){
        this.$http.get("student", {params:{method:"getSelectedCourse",id:"B15010102"}}).then(response => {
      ...
      dropCourse(){
        if(this.selected.length == 0){
          ...
          var params = "?method=dropCourse&sid=B15010102";
